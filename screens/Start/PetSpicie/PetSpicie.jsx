...
const PetSpicie = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.spicieContainer}>
      <Level level="1" />
      ...
      <View style={styles.spicies}>
        ...
        <Pressable
          ...
          style={[
            ...
            styles.fish,
            {
              borderStyle: spicie === "fish" ? "dotted" : "solid",
              borderWidth: spicie === "fish" ? 3 : 0,
              borderColor: spicie === "fish" ? "#EE7942" : "#FFFFFF",
            },
          ]}
        >
          <View style={[styles.spiciePhoto, styles.spiciePhotoDog]}>
          ...
          <Text style={[styles.spicieText, styles.spicieTextFish]}>Fish</Text>
        </Pressable>
        ...
        <Pressable
          ...
          style={[
            ...
            styles.bird,
            {
              borderStyle: spicie === "bird" ? "dotted" : "solid",
              borderWidth: spicie === "bird" ? 3 : 0,
              borderColor: spicie === "bird" ? "#EE7942" : "#FFFFFF",
            },
          ]}
        >
          <View style={[styles.spiciePhoto, styles.spiciePhotoDog]}>
          ...
          <Text style={[styles.spicieText, styles.spicieTextBird]}>Bird</Text>
        </Pressable>
